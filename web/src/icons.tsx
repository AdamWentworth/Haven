...
export function HavenIcon(props: IconProps) {
  ...
  return <svg className={className} width={size} height={size} viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M11.35 1.93Q12 1.67 12.65 1.93l7.38 2.99q.52.21.52.77v5.72c0 4.83-3.08 8.41-8 10.18q-.55.2-1.1 0c-4.92-1.77-8-5.35-8-10.18V5.69q0-.56.52-.77l7.38-2.99Z" fill="#73e2a7" /><path d="M11.56 3.63q.44-.18.88 0l6.04 2.45q.37.15.37.55v4.78c0 3.83-2.4 6.74-6.48 8.3q-.37.14-.74 0c-4.08-1.56-6.48-4.47-6.48-8.3V6.63q0-.4.37-.55l6.04-2.45Z" fill="#10251d" /><rect x="7.6" y="7.1" width="2.35" height="9.8" rx="0.7" fill="#dff5e8" /><rect x="14.05" y="7.1" width="2.35" height="9.8" rx="0.7" fill="#dff5e8" /><rect x="9.25" y="10.9" width="5.5" height="2.2" rx="1.1" fill="#dff5e8" /></svg>;
}
