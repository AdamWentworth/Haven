...
export function HavenIcon(props: IconProps) {
  ...
  return <svg className={className} width={size} height={size} viewBox="0 0 24 24" aria-hidden="true" focusable="false">
    ...
    <path d="M7.55 7 9.45 5.92 9.62 6.02V10.25H14.38V6.02L14.55 5.92 16.45 7 16.58 7.25V15.55L16.45 15.82 14.55 17.12 14.38 17.35V12.55H9.62V17.35L9.45 17.12 7.55 15.82 7.42 15.55V7.25L7.55 7Z" fill={`url(#${monogram})`} />
  </svg>;
}
