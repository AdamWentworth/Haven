...
export function HavenIcon(props: IconProps) {
  ...
  return <svg className={className} width={size} height={size} viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M12 1.75 20.65 5.2v6.4c0 5.2-3.45 8.55-8.65 10.25C6.8 20.15 3.35 16.8 3.35 11.6V5.2L12 1.75Z" fill="#73e2a7" /><path d="M12 3.45 19.05 6.25v5.35c0 4.2-2.7 6.95-7.05 8.48-4.35-1.53-7.05-4.28-7.05-8.48V6.25L12 3.45Z" fill="#10251d" /><path d="M7.7 7.25h2.15v3.55h4.3V7.25h2.15v9.5h-2.15V13h-4.3v3.75H7.7v-9.5Z" fill="#dff5e8" /><path d="m12 10.65 1.35 1.35L12 13.35 10.65 12 12 10.65Z" fill="#73e2a7" /></svg>;
}
