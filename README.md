...
- A Chrome-only, per-profile site-data review that groups current cookies by domain and shows aggregate totals, session/persistent scope, Secure and HTTP-only coverage, last access, and latest persistent expiry
