...
- One canonical transparent shield-and-H mark shared by the dashboard, repository presentation, favicon, and native desktop package
...
- Deterministic standard-library asset generation plus tests for transparency, maskability, desktop parity, manifest purpose, and local-only delivery
