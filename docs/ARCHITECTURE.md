...
Milestone 0.21 adds encrypted browser-site curation to the live Chrome profile review while retaining the 0.20 evidence boundary, browser inventory, hardened Electron client, installable-web fallback, private account-security notebook, verifiable fleet lifecycle evidence, routed console, reliability guardrails, and bounded read-only NAS health evidence:
