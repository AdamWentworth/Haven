...
| Owner review changes interruption, not observed fact | Current finding plus the latest owner review and hub clock | Go policy and API tests suppress accepted-risk findings and active snoozes while retaining acknowledged findings and expired snoozes in the active projection |
