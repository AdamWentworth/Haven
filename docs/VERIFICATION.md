...
| Brand polish does not create tracking, cropping, or Windows small-icon regressions | Canonical local vector geometry plus purpose-specific generated rasters and ICO entries | Tests require a transparent standard mark with the smooth shield and rounded monogram palette intact, an optically larger desktop mark, an opaque maskable tile, explicit manifest purposes, nine decodable transparent Windows sizes from 16–256px, and deterministic regeneration in CI |
