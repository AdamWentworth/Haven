...
| Brand polish does not create tracking or platform-cropping regressions | Canonical local vector geometry plus purpose-specific generated rasters | Tests require a transparent standard and desktop mark, an opaque maskable tile, explicit manifest purposes, byte-identical desktop/512px standard assets, and deterministic regeneration in CI |
